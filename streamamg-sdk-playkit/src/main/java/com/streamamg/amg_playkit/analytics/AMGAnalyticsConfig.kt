...
class AMGAnalyticsConfig {
    private val log = PKLog.get(AMGAnalyticsConfig::class.java.simpleName)
    ...
    val DEFAULT_BASE_URL = "https://analytics.kaltura.com/api_v3/index.php"
    ...
    fun setPartnerId(partnerId: Int?): AMGAnalyticsConfig {
        this.partnerId = partnerId
        return this
    }

    fun setBaseUrl(baseUrl: String?): AMGAnalyticsConfig {
        this.baseUrl = baseUrl
        return this
    }

    fun setKs(ks: String?): AMGAnalyticsConfig {
        this.ks = ks
        return this
    }

    fun setEntryId(entryId: String?): AMGAnalyticsConfig {
        this.entryId = entryId
        return this
    }

    fun setDvrThreshold(dvrThreshold: Long): AMGAnalyticsConfig {
        this.dvrThreshold = dvrThreshold
        return this
    }

    fun setUiConfId(uiConfId: Int?): AMGAnalyticsConfig {
        uiconfId = uiConfId
        return this
    }

    fun setUserId(userId: String?): AMGAnalyticsConfig {
        this.userId = userId
        return this
    }

    fun setCustomVar1(customVar1: String?): AMGAnalyticsConfig {
        this.customVar1 = customVar1
        return this
    }

    fun setCustomVar2(customVar2: String): AMGAnalyticsConfig {
        this.customVar2 = customVar2
        return this
    }

    fun setCustomVar3(customVar3: String): AMGAnalyticsConfig {
        this.customVar3 = customVar3
        return this
    }

    fun setReferrer(referrer: String?): AMGAnalyticsConfig {
        this.referrer = referrer
        return this
    }

    fun setPlaybackContext(playbackContext: String?): AMGAnalyticsConfig {
        this.playbackContext = playbackContext
        return this
    }

    fun setPlaylistId(playlistId: String?): AMGAnalyticsConfig {
        this.playlistId = playlistId
        return this
    }

    fun setApplicationVersion(applicationVersion: String?): AMGAnalyticsConfig {
